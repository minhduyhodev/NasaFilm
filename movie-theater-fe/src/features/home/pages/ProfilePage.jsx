          ...
          <div className="profile-container">
            ...
            <div className="space-hub-header">
              ...
              <div className="space-hub-content grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="profile-membership-card lg:col-span-7 flex flex-col md:flex-row items-center gap-8 bg-black/35 backdrop-blur-xl border border-white/5 p-8 rounded-3xl relative overflow-hidden group">
                                    ...
                                    >
                                      ...
                                      <div className="voucher-body text-left">
                                        <div className="voucher-card__header">
                                          ...
                                          <span
                                            className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${isDirectUse
