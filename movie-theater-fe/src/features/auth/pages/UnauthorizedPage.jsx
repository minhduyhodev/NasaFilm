...
import { ShieldAlert, Home, LogOut, LayoutDashboard } from 'lucide-react';
      ...
      <div className="max-w-md w-full text-center relative z-10">
        <div className="bg-[#0f111a]/80 border border-white/5 backdrop-blur-2xl rounded-[32px] p-8 shadow-[0_30px_70px_rgba(0,0,0,0.5)] flex flex-col items-center">
          ...
          <p className="text-sm text-[#8a8d9f] font-medium leading-relaxed mb-8">
            {staffUser
              ? 'Tài khoản quản trị không dùng được khu vực khách hàng. Vui lòng quay lại cổng quản trị.'
              : 'Tài khoản của bạn không được cấp quyền truy cập vào trang này. Vui lòng quay lại trang chủ hoặc đăng nhập bằng tài khoản có đặc quyền phù hợp.'}
          </p>
