...
const AdminActorDetailPage = lazy(
...
const AdminVoucherFormPage = lazy(
  () => import("../pages/AdminVoucherFormPage"),
);
const AdminVoucherDetailPage = lazy(
  () => import("../pages/AdminVoucherDetailPage"),
);
const AdminCombosPage = lazy(() => import("../pages/AdminCombosPage"));
const AdminComboFormPage = lazy(() => import("../pages/AdminComboFormPage"));
const AdminComboDetailPage = lazy(
  () => import("../pages/AdminComboDetailPage"),
);
    ...
    <Suspense fallback={<AdminPageLoader />}>
      <Routes>
        <Route element={<AdminLayout />}>
          ...
          <Route
            path="actors/:actorUuid/edit"
            element={<AdminActorFormPage />}
          />
          ...
          <Route
            path="cinemas/:cinemaUuid/edit"
            element={<AdminCinemaFormPage />}
          />
          <Route
            path="cinemas/:cinemaUuid/rooms/new"
          ...
          <Route
            ...
            element={<AdminVoucherFormPage />}
          />
          <Route
            path="vouchers/:voucherId"
            element={<AdminVoucherDetailPage />}
          />
          <Route path="combos" element={<AdminCombosPage />} />
          <Route path="combos/new" element={<AdminComboFormPage />} />
          <Route
            path="combos/:comboUuid/edit"
            element={<AdminComboFormPage />}
          />
