-- Reference migration for mission long-term schema (applied at runtime via MissionSchemaMigrator).
-- Not executed by Flyway; kept for documentation and manual DBA use.
