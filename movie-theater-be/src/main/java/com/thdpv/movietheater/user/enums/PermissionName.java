...
public enum PermissionName {
    ...
    CINEMA_WRITE("Quản lý rạp, phòng và sơ đồ ghế", "Facility"),
    COMBO_WRITE("Quản lý combo", "Content"),
    PROMOTION_WRITE("Quản lý khuyến mãi", "Content"),
    MISSION_MANAGE("Quản lý nhiệm vụ và chiến dịch", "Content"),
    DISCOVER_MANAGE("Quản lý Matchmaker và gợi ý phim", "Content"),
    REPORT_VIEW("Xem dashboard và báo cáo doanh thu", "Reports"),
    USER_VIEW("Xem danh sách user", "Admin ops"),
    SUPPORT_MANAGE("Quản lý support ticket", "Admin ops"),
    HR_VIEW("Xem danh bạ nhân sự", "Nhân sự"),
    HR_PROFILE_MANAGE("Quản lý hồ sơ nhân sự", "Nhân sự"),
    HR_HOLIDAY_MANAGE("Quản lý ngày lễ", "Nhân sự"),
    ...
    public static Set<PermissionName> presetPermissions(String preset) {
        ...
        return switch (preset.trim().toUpperCase()) {
            ...
            case "CONTENT" -> Set.of(
                    MOVIE_WRITE, SHOWTIME_WRITE, COMBO_WRITE, PROMOTION_WRITE,
                    MISSION_MANAGE, DISCOVER_MANAGE);
            case "FACILITY" -> Set.of(CINEMA_WRITE, SHOWTIME_WRITE);
            case "HR" -> Set.of(
                    HR_VIEW, HR_PROFILE_MANAGE, HR_HOLIDAY_MANAGE,
                    HR_SHIFT_MANAGE, HR_ATTENDANCE_MANAGE, HR_PAYROLL_MANAGE);
            case "REPORTS" -> Set.of(REPORT_VIEW);
